      ...
      <div class="settings-app__content gui-scrollable">
        ...
        <div class="k-ios-list">
          ...
          <div class="k-ios-list__item" @click="toggleCustomAccent">
            <div class="k-ios-list__item-left">
              <div class="k-ios-list__item-content">
                <div class="k-ios-list__item-label">{{ t('settings.enableCustomAccent') || 'Enable Custom Accent' }}</div>
                <div class="k-ios-list__item-description">{{ t('settings.enableCustomAccentDesc') || 'Override accent color' }}</div>
              </div>
            </div>
            <div class="k-ios-list__item-right">
              <ToggleSwitch :active="!!themeStore.customAccentColor" @update:active="toggleCustomAccent" />
            </div>
          </div>

          <!-- Custom Accent Color Picker -->
          <div v-if="!!themeStore.customAccentColor" class="k-ios-list__item" style="flex-direction: column; align-items: stretch; gap: 8px; cursor: default;">
            <div class="flex justify-between items-center w-full">
              <span class="k-ios-list__item-label" style="font-size: 13px;">{{ t('settings.pickAccentColor') || 'Choose Color' }}</span>
              <span class="k-ios-list__item-value" style="font-size: 11px;">{{ themeStore.customAccentColor }}</span>
            </div>
            <CustomAccentPicker
