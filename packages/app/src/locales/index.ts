...
export const en = {
  ...
  'proxy.advancedOptions': 'Advanced',
  'proxy.collapseOptions': 'Collapse',
  'proxy.filename': 'Filename',
  'proxy.autoDetect': 'Auto detect',
  'proxy.rateLimit': 'Rate Limit (KB/s)',
  'proxy.noLimit': '0 = unlimited',
  'proxy.cancelDownload': 'Cancel Download',
  'proxy.downloaded': 'Downloaded',
  'proxy.progress': 'Progress',
  'proxy.currentSpeed': 'Speed',
  'proxy.eta': 'ETA',
  'proxy.elapsed': 'Elapsed',
  'proxy.avgSpeed': 'Avg Speed',
  'proxy.peak': 'Peak',
  'proxy.realtimeSpeed': 'Live Speed',
  'proxy.current': 'Current',
  'proxy.average': 'Average',
  'proxy.downloadComplete': 'Download Complete',
  'proxy.newDownload': 'New Download',
  'proxy.duration': 'Duration',
  'proxy.statistics': 'Statistics',
  'proxy.totalDownloads': 'Total',
  'proxy.completed': 'Completed',
  'proxy.cancelled': 'Cancelled',
  'proxy.totalTraffic': 'Traffic',
  'proxy.successRate': 'Success',
  'proxy.history': 'History',
  'proxy.refresh': 'Refresh',
  'proxy.noHistory': 'No downloads yet',
  'proxy.loadMore': 'Load More ({n})',
  'proxy.delete': 'Delete',
  'proxy.statusReady': 'Ready',
  'proxy.statusTransferring': 'Transferring',
  'proxy.statusDone': 'Done',
  'proxy.statusFailed': 'Failed',
  'proxy.statusCompleted': 'Completed',
  'proxy.enterUrl': 'Enter download URL...',
  'proxy.customFilename': 'Custom filename',
  'proxy.rateLimitPlaceholder': 'Rate limit KB/s',
  'proxy.errorEmptyUrl': 'Please enter a download URL',
  'proxy.errorInvalidUrl': 'Please enter a valid HTTP/HTTPS URL',
  'proxy.timeJustNow': 'Just now',
  'proxy.timeMinAgo': '{n}m ago',
...
export const zhCN: Record<string, string> = {
  ...
  // ── Download Proxy ──────────────────────────────────────────────────
  'proxy.download': '下载',
  'proxy.advancedOptions': '高级选项',
  'proxy.collapseOptions': '收起选项',
  'proxy.filename': '文件名',
  'proxy.autoDetect': '自动识别',
  'proxy.rateLimit': '速率限制 (KB/s)',
  'proxy.noLimit': '0 = 不限',
  'proxy.cancelDownload': '取消下载',
  'proxy.downloaded': '已下载',
  'proxy.progress': '进度',
  'proxy.currentSpeed': '当前速度',
  'proxy.eta': '预计剩余',
  'proxy.elapsed': '已耗时',
  'proxy.avgSpeed': '平均速度',
  'proxy.peak': '峰值',
  'proxy.realtimeSpeed': '实时速度',
  'proxy.current': '当前',
  'proxy.average': '平均',
  'proxy.downloadComplete': '下载完成',
  'proxy.newDownload': '新下载',
  'proxy.duration': '耗时',
  'proxy.statistics': '数据统计',
  'proxy.totalDownloads': '总下载',
  'proxy.completed': '已完成',
  'proxy.cancelled': '已取消',
  'proxy.totalTraffic': '总流量',
  'proxy.successRate': '成功率',
  'proxy.history': '历史记录',
  'proxy.refresh': '刷新',
  'proxy.noHistory': '暂无下载记录',
  'proxy.loadMore': '加载更多 ({n})',
  'proxy.delete': '删除',
  'proxy.statusReady': '就绪',
  'proxy.statusTransferring': '传输中',
  'proxy.statusDone': '完成',
  'proxy.statusFailed': '失败',
  'proxy.statusCompleted': '已完成',
  'proxy.enterUrl': '输入下载链接...',
  'proxy.customFilename': '自定义文件名',
  'proxy.rateLimitPlaceholder': '速率限制 KB/s',
  'proxy.errorEmptyUrl': '请输入下载链接',
  'proxy.errorInvalidUrl': '请输入有效的 HTTP/HTTPS 链接',
  'proxy.timeJustNow': '刚刚',
  'proxy.timeMinAgo': '{n} 分钟前',
