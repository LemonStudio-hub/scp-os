                ...
                desktop: {
                  ...
                  children: {
                    'terminal.desktop': {
                      ...
                      owner: 'scp', group: 'foundation', size: 70, mtime: Date.now(),
                    ...
                    'files.desktop': {
                      ...
                      type: 'file',
                      permissions: { user: { read: true, write: true, execute: false }, group: { read: true, write: false, execute: false }, others: { read: true, write: false, execute: false } },
                      owner: 'scp', group: 'foundation', size: 62, mtime: Date.now(),
                      content: '[Desktop Entry]\nName=Files\nType=Application\nTool=filemanager\nIcon=folder\nX=180\nY=50',
                    },
                    'chat.desktop': {
                      name: 'chat.desktop',
                      type: 'file',
                      permissions: { user: { read: true, write: true, execute: false }, group: { read: true, write: false, execute: false }, others: { read: true, write: false, execute: false } },
                      owner: 'scp', group: 'foundation', size: 58, mtime: Date.now(),
                      content: '[Desktop Entry]\nName=Chat\nType=Application\nTool=chat\nIcon=chat\nX=310\nY=50',
                    },
                    'dash.desktop': {
                      name: 'dash.desktop',
                    ...
                    'settings.desktop': {
                      ...
                      type: 'file',
                      permissions: { user: { read: true, write: true, execute: false }, group: { read: true, write: false, execute: false }, others: { read: true, write: false, execute: false } },
                      owner: 'scp', group: 'foundation', size: 72, mtime: Date.now(),
                      content: '[Desktop Entry]\nName=Settings\nType=Application\nTool=settings\nIcon=settings\nX=50\nY=310',
                    },
                    'editor.desktop': {
                      name: 'editor.desktop',
