...
export class ErrorHandler {
  ...
  private getTypeDisplay(type: string): string {
    const typeMap: Record<string, string> = {
      ...
      [ErrorType.GESTURE_INIT_FAILED]: 'Gesture initialization failed',
      [ErrorType.GESTURE_DESTROY_FAILED]: 'Gesture disposal failed',
      [ErrorType.GESTURE_EVENT_FAILED]: 'Gesture event failed',
      [ErrorType.GESTURE_SETUP_FAILED]: 'Gesture setup failed',
      [ErrorType.GESTURE_HANDLER_FAILED]: 'Gesture handler failed',
